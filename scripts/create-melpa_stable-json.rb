...
archives = Net::HTTP.get(URI.parse('https://stable.melpa.org/archive.json'))
recipes = Net::HTTP.get(URI.parse('https://raw.githubusercontent.com/conao3/feather-melpa/master/html-stable/recipes.json'))
