...
archives = Net::HTTP.get(URI.parse('https://files.conao3.com/feather-recipes/lite-archives.json'))
recipes = Net::HTTP.get(URI.parse('https://files.conao3.com/feather-recipes/lite-recipes.json'))
